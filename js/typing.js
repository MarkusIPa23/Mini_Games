    ...
    constructor(level, language = 'lv') {
        ...
        this.texts = {
            lv: {
                ...
                hard: [
                    "Pēdējās dienas decembrī Rīta gaisma krāsoja sniegoto pilsētu rozā un zeltainās krāsās. Anna juta jaunu cerību sirdī šis gads solījās būt citāds. Viņa devās uz pilsētas laukumu, kur ik gadu pulcējās cilvēki, lai sagaidītu Jauno gadu. Apkārt smaržoja karstā šokolāde un piparkūkas, bērnu smiekli skanēja kā mazi zvani. Kad pulkstenis tuvojās pusnaktij, Anna satvēra drauga roku, un abi skaitīja atpakaļ: “Trīs… divi… viens…” Pulkstenis iešāva un debesis aizdegās krāšņās uguņošanas gaismās. Sirdī Anna juta gan prieku, gan cerību. Jaunais gads solīja jaunus piedzīvojumus, sapņus un smaidus. Viņa ieelpoja auksto ziemas gaisu un nodomāja: “Šis būs mans gads.” Apkārt valdošā dzīvīgā enerģija lika viņai ticēt, ka viss ir iespējams, un pilsēta svinēja kopā ar viņu.",
